        ...
        <Box sx={{marginTop: 8, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center',}}>
            ...
            <Grid item xs={12} sm={6}>
                ...
                <CardActionArea component={Link} to="/login/cliente" sx={{ height: '100%', p: 3 }}>
                    ...
                    <Typography gutterBottom variant="h5" component="div" sx={{ mt: 2 }}>Sou Cliente</Typography>
                    <Typography variant="body2" color="text.secondary">Acessar sua área para visualizar empréstimos e informações pessoais.</Typography>
                    </CardContent>
                </CardActionArea>
                </Card>
            </Grid>
